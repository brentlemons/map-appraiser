...
# =====================================================
# Deploy Appraisal Notices ETL Job
# Creates AWS Glue job to load appraisal notice CSV data into Aurora PostgreSQL
# =====================================================

set -e

# Configuration
STACK_NAME="appraisal-notices-etl-job"
TEMPLATE_FILE="appraisal-notices-glue-job.yaml"
SCRIPT_FILE="appraisal_notices_etl.py"
REGION="us-west-2"
...
show_usage() {
    ...
    echo
    echo "Deploy Appraisal Notices ETL Job"
    echo
    echo "Options:"
    ...
    echo "  aws glue start-job-run --job-name appraisal-notices-etl"
    echo
    echo "Or for a specific year:"
    echo "  aws glue start-job-run --job-name appraisal-notices-etl --arguments='{\"--TARGET_YEAR\":\"2025\"}'"
}
...
main() {
    echo "======================================================="
    echo "  Appraisal Notices ETL Job Deployment"
    echo "======================================================="
    echo
    ...
    echo "  aws glue get-job-runs --job-name appraisal-notices-etl"
}
