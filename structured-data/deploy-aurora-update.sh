...
# Update script for Aurora Serverless PostgreSQL database to enable public access

set -e

STACK_NAME="map-appraiser-aurora-db"
TEMPLATE_FILE="aurora-update-public.yaml"
REGION="us-west-2"
...
echo "Updating Aurora Serverless PostgreSQL database for public access..."
echo "Region: $REGION"
